...
function LoadingPage() {
    ...
    $(window).on("load", function () {
        ...
        queue.loadManifest([{
            ...
            {
                id: "16",
                src: "./assets/img/object/app_stages.png"
            },
            {
                id: "16",
...
function slicerbg() {
    $('body').append('<div class="overlay-swipe"><div class="is_slice is_filter"><div class="is_sliceBG left"><div class="over-1"></div><div class="over-2"></div></div><div class="is_sliceBG right"><div class="over-1"></div><div class="over-2"></div></div><div class="is_waitfilter"><span class="text">DEXSWAP PROJECT</span></div></div></div>');
...
function ieoevents() {
    ...
    function crt2() {
        ...
        if (!is_mobile) {
            ...
            TweenMax.to(".aria_bar #infrs_bar", 3, {
                bezier: {
                    values: [{
                        left: '-50%',
                        width: 100
...
function timelineholder() {
    var second = 1000;
    var minute = second * 60;
    var hour = minute * 60;
    var day = hour * 24;
    var curentTime = new Date().getTime();
    var $ist1 = $(".txt_one #let_chars");
    var $ist2 = $(".txt_second #let_chars");
    var $ist3 = $(".txt_third #let_chars");
    var $ist4 = $(".txt_forth #let_chars");
    var $istBase = $('.tcount-h #let_chars2');
    var textbanner1 = new SplitText($ist1, {
        type: "chars"
    });
    var textbanner2 = new SplitText($ist2, {
        type: "chars"
    });
    var textbanner3 = new SplitText($ist3, {
        type: "chars"
    });
    var textbanner4 = new SplitText($ist4, {
        type: "chars"
    });
    var textbannerbase = new SplitText($istBase, {
        type: "chars"
    });
    var $tbaner1 = textbanner1.chars;
    var $tbaner2 = textbanner2.chars;
    var $tbaner3 = textbanner3.chars;
    var $tbaner4 = textbanner4.chars;
    var $tbanerbase = textbannerbase.chars;
    var timbaner1 = new TimelineLite({
        onComplete: ftext1,
        paused: !0
    });
    var timbaner2 = new TimelineLite({
        onComplete: ftext2,
        paused: !0
    });
    var timbaner3 = new TimelineLite({
        onComplete: ftext3,
        paused: !0
    });
    var timbaner4 = new TimelineLite({
        onComplete: ftext4,
        paused: !0
    });
    var timbanerbase = new TimelineLite({
        onComplete: ftextbase,
        paused: !0
    });
    ...
    function ftextbase() {
        var timbanerbase = new TimelineLite();
        timbanerbase.staggerFromTo($tbanerbase, 0.5, {
            opacity: .3,
        }, {
            color: "hsl(27, 96%, 51%)",
            opacity: 1,
    ...
    bJULI = new Date("2019-09-07 00:00:00").getTime();
    bAGUSTUS = new Date("2019-09-06 00:00:00").getTime();
    bSEPTEMBER = new Date("2019-09-05 00:00:00").getTime();
    bsepEND = new Date("2022-10-05 00:00:00").getTime();
    if (parseInt(curentTime) <= parseInt(bJULI)) {
        var countDown = new Date("2019-09-07 23:59:00").getTime();
        TweenMax.to([$ist2, $ist3, $ist4], 0, {
            visibility: "hidden",
            opacity: 0,
            clearProps: "all",
            onComplete: function () {
                ...
                timbaner4.kill();
                timbaner3.kill();
                $(".txt_second, .txt_third, .txt_forth").remove()
            }
        })
    } else if (parseInt(curentTime) <= parseInt(bAGUSTUS)) {
        var countDown = new Date("2019-09-06 23:59:00").getTime();
        TweenMax.to([$ist1, $ist3, $ist4], 0, {
            visibility: "hidden",
            opacity: 0,
            clearProps: "all",
            onComplete: function () {
                ...
                timbaner4.kill();
                timbaner3.kill();
                $(".txt_one, .txt_third, .txt_forth").remove()
            }
        })
    } else if (parseInt(curentTime) <= parseInt(bSEPTEMBER)) {
        var countDown = new Date("2019-09-05 23:59:00").getTime();
        TweenMax.to([$ist1, $ist2], 0, {
            visibility: "hidden",
            opacity: 0,
            clearProps: "all",
            onComplete: function () {
                ...
                timbaner1.kill();
                timbaner4.kill();
                $(".txt_one, .txt_second, .txt_forth").remove()
            }
        })
    } else if (parseInt(curentTime) <= parseInt(bsepEND)) {
        var countDown = new Date("2022-10-05 23:59:00").getTime();
        TweenMax.to([$ist1, $ist2, $ist3], 0, {
            visibility: "hidden",
            opacity: 0,
            clearProps: "all",
            onComplete: function () {
                ...
                timbaner1.kill();
                timbaner4.play();
                $(".txt_one, .txt_second, .txt_third").remove();
                TweenMax.set(".tcount-h", {
                    visibility: "hidden"
                })
            }
        })
    }
    var variabletime = setInterval(function () {
